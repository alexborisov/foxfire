...
FOX_db::runInsertQueryMulti() functions exactly like FOX_db::runInsertQuery(), except its $data parameter is an array of arrays. It combines all of
the rows into passed in its $data array into a single query.
