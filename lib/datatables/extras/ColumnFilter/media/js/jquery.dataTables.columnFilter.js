    ...
    ColumnFilter.prototype = {
	    ...
	    */
	    "_fnCreateDateRangeInput": function(args){
		    ...
		    from.datepicker({ beforeShowDay: function(date){ 
			    ...
			    if( !$('#' + parent._oConfig.sTableId + 'range_to_' + args.index).hasClass("is_empty") ){
				    ...
				    if(fromDate > toDate){
					    ...
					    return [false, '', 'Cannot be more than TO value'];
				    }
				    else {					    
					    return [true, ''];
				    }
		    ...
		    to.datepicker({ beforeShowDay: function(date){ 
			    ...
			    if( !$('#' + parent._oConfig.sTableId + 'range_from_' + args.index).hasClass("is_empty") ){
				    ...
				    if(toDate < fromDate){
					    ...
					    return [false, '', 'Cannot be less than FROM value'];
				    }
				    else {					    
					    return [true, ''];
				    }
