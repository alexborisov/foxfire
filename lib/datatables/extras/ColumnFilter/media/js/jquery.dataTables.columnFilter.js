    ...
    ColumnFilter.prototype = {
	    ...
	    */
	    "_fnCreateRangeInput": function(args){	    
		    ...
		    var from = $('<input type="text" class="number_range_filter" id="' + sFromId + '" rel="' + args.index + '" value="' + parent._oConfig.aoColumns[args.index].oRangeFormat.from + '"/>');

		    args.th.html(from);

		    var sToId = this._oConfig.sTableId + 'range_to_' + args.index;
		    var to = $('<input type="text" class="number_range_filter" id="' + sToId + '" rel="' + args.index + '" value="' + parent._oConfig.aoColumns[args.index].oRangeFormat.to + '"/>');
	    ...
	    */
	    "_fnCreateDateRangeInput": function(args){
		    ...
		    var sFromId = this._oConfig.sTableId + 'range_from_' + args.index;
		    //var from = $('<input type="text" class="date_range_filter" id="' + sFromId + '" rel="' + args.index + '" value="' + parent._oConfig.aoColumns[args.index].oRangeFormat.from + '"/>');
		    ...
		    var sToId = this._oConfig.sTableId + 'range_to_' + args.index;
		    //var to = $('<input type="text" class="date_range_filter" id="' + sToId + '" rel="' + args.index + '" value="' + parent._oConfig.aoColumns[args.index].oRangeFormat.to + '"/>');
