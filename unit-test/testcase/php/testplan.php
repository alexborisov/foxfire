...
//			),
			...
			"base" => array(
				...
				array( "enable"=>false,	 "name"=>"L5 Paged (Add)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_add.php" ),
				array( "enable"=>false,	 "name"=>"L5 Paged (Set)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_set.php" ),
				array( "enable"=>false,	 "name"=>"L5 Paged (Get)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_get.php" ),
				array( "enable"=>false,	 "name"=>"L5 Paged (Replace)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_replace.php" ),
				array( "enable"=>false,	 "name"=>"L5 Paged (Drop)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_drop.php" ),
				array( "enable"=>false,	 "name"=>"L5 Paged (Global)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_global.php" ),			    
			    	array( "enable"=>true,	 "name"=>"L5 Paged (ACID)",	"mock"=>array(), "file"=>"/tests/base_classes/paged_L5/test_base.db.store.paged.L5_ACID.php" ),	
