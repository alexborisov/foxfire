...
class core_L4_paged_abstract_replaceMethods extends RAZ_testCase {
	...
	*/	
	public function test_replaceL2_multi_COLD() {
		...
		$data = array(
				1=>array(   'X'=>array(	'K'=>array(), // Drop this L2 node
							'R'=>array( 
								    9=>'foo',
								    3=>'bar'
		...
		$check_cache_1 = array(	    'L2'=>array(    'X'=>array( 
									'R'=>true,
									'V'=>true
							    ),
							    'E'=>array( 
		...
		$check_cache_3 = array(	    'L2'=>array(    'X'=>array( 'K'=>true,
									'Z'=>true
					    )),			    
		...
		$check_data_1 = array(  'X'=>array( 'R'=>array( 	
								9=>'foo',
								3=>'bar'													    
						    ),				    
						    'V'=>array( 	
	...
	*/	
	public function test_replaceL2_multi_WARM() {
		...
		$data = array(
				1=>array(   'X'=>array(	'K'=>array(), // Drop the L2 'K' node
							'R'=>array( 
								    9=>'foo',
								    3=>'bar'								    					    
							),				    
	...
	*/	
	public function test_replaceL2_multi_HOT() {
		...
		$data = array(
				1=>array(   'X'=>array(	'K'=>array(), // Drop this L2 'K'
							'R'=>array( 
								    9=>'foo',
								    3=>'bar'								    					    
							),				    
		...
		$check_cache_2 = array(	    'all_cached'=>true,	    // $all_cached will be true because this L4 had					     
					    'L3'=>null,		    // authority from the previous GET operation
					    'L2'=>null,				    
					    'keys'=>array(  'X'=>array(	'K'=>array( 
										    1=>(string)"foo",
		...
		$check_cache_3 = array(	    'L2'=>array(    'X'=>array( 'K'=>true,	// This L4 didn't exist when the GET operation ran. It
	...
	*/	
	public function test_replaceL3_multi_COLD() {
		...
		$check_cache_1 = array(	    'L3'=>array(    'X'=>true,
							    'E'=>true,					    						
					    ),
		...
		$check_cache_3 = array(	    'L3'=>array(    'X'=>true	),			    
					    'keys'=>array(  'X'=>array(	'K'=>array( 
										    1=>(string)"foo",
										    2=>array(null, true, false, 1, 1.0, "foo")										    							    
									),
	...
	*/	
	public function test_replaceL3_multi_HOT() {
		...
		$check_cache_3 = array(	    'L3'=>array(    'X'=>true	),		// Only has L3 authority, since it wasn't
