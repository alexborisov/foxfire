...
class core_L3_paged_abstract_setMethods extends RAZ_testCase {
	...
	*/	
	public function test_setL1() {
		...
		try {
			$rows_changed = $this->cls->setL1('A', 'X', 3, 0, $ctrl=null);
	...
	*/	
	public function test_setL2() {
		...
		$test_data = array(
				...
				array( "L3"=>'A', "L2"=>"X", "L1s"=>array(
										    1=>null,
										    2=>false,
										    5=>true,
										    3=>(int)0
										)), 
				array( "L3"=>'A', "L2"=>"Y", "L1s"=>array(
										    1=>(int)1,
										    2=>(int)-1,
										    3=>(float)1.7,
										    4=>(float)-1.6
										)), 
		    		array( "L3"=>'B', "L2"=>"K", "L1s"=>array(
										    1=>(string)"foo",
										    2=>array(null, true, false, 1, 1.0, "foo"),
										    3=>$test_obj
										))
		...
		try {		    
			...
			$rows_changed = $this->cls->setL2('A', "X", array( 3=>(int)0 ), $ctrl=null);
	...
	*/	
	function test_setL2_multi() {
		...
		$test_data = array(
				...
				array( "L3"=>'A', "L2"=>"X", "L1"=>array(
										    1=>null,
										    2=>false,
										    5=>true,
										    3=>(int)0
										)), 
				array( "L3"=>'A', "L2"=>"Y", "L1"=>array(
										    1=>(int)1,
										    2=>(int)-1,
										    3=>(float)1.7,
										    4=>(float)-1.6
										)), 
		    		array( "L3"=>'B', "L2"=>"K", "L1"=>array(
										    1=>(string)"foo",
										    2=>array(null, true, false, 1, 1.0, "foo"),
										    3=>$test_obj
										))
		...
		$dupe_items = array(
				array( "L3"=>'A', "L2"=>"X", "L1"=>array(1=>null,2=>false))
		);
		...
		$dupe_items = array(
				array( "L3"=>'A', "L2"=>"X", "L1"=>array(3=>(int)0)),
				array( "L3"=>'A', "L2"=>"Y", "L1"=>array(1=>(int)1,2=>(int)-1)),
		);
	...
	*/	
	...
	function test_setL3() {
		...
		try {			
			$rows_changed = $this->cls->setL3('A', array( "Y"=>array(
										    1=>(int)1,												
										    2=>(int)-1,									
										    3=>(float)1.7,
										    4=>(float)-1.6
