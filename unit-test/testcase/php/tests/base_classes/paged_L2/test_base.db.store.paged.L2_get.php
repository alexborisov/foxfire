...
class core_L2_paged_abstract_getMethods extends RAZ_testCase {
	...
	*/	
	public function test_getMulti_matrix_L1() {
		...
		$check_cache_warm = array(		    
					    ...
					    3=>array(   // There will be no LUT arrays, because all request data is fully-qualified 
							// L4->L1 walks, and all requested items are already in the cache, so
							// neither the persistent cache nor db load code runs
	...
	*/	
	...
	public function test_getL1_single_trie() {
		...
		try {			
			$result = $this->cls->getL1(2, 2, $ctrl, $valid);
		}
		catch (FOX_exception $child) {
	...
	*/	
	...
	public function test_getL1_multi_trie() {
		...
		try {			
			$result = $this->cls->getL1(2, array(1,2), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
	...
	*/	
	...
	public function test_getL2_multi_trie() {
		...
		try {			
			$result = $this->cls->getL2( array(1,2), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
	...
	*/	
	...
	public function test_dataIntegrity_validFlag() {
		...
		try {			
			$result = $this->cls->getL1(1, 1, $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL1(1, 99, $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL1(1, array(1,99), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL1(1, array(88,99), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL2(99, $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL2(array(1,99), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
		...
		try {			
			$result = $this->cls->getL2(array(99,88), $ctrl, $valid);
		}
		catch (FOX_exception $child) {
	...
	*/	
	...
	public function test_dataIntegrity_keyType() {
		...
		try {			
			$result = $this->cls->getL1(1, "T", $ctrl, $valid);
		...
		try {			
			$result = $this->cls->getL1(1, array(1, "T"), $ctrl, $valid);
		...
		try {			
			$result = $this->cls->getL1(1, array("Q", "T"), $ctrl, $valid);
		...
		try {			
			$result = $this->cls->getL2('7', $ctrl, $valid);
		...
		try {			
			$result = $this->cls->getL2(array('F','4'), $ctrl, $valid);
