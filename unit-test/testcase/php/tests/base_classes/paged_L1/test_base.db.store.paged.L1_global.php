...
class FOX_dataStore_paged_L1_tester_globalMethods extends FOX_dataStore_paged_L1_base {
...
}  // ENDOF: class FOX_dataStore_paged_L1_tester_globalMethods 

                                      

/**
 * FOXFIRE UNIT TEST SCRIPT - L1 PAGED ABSTRACT DATASTORE CLASS - GLOBAL METHODS
 *
 * @version 1.0
 * @since 1.0
 * @package FoxFire
...
class core_L1_paged_abstract_globalMethods extends RAZ_testCase {
		...
		$this->cls = new FOX_dataStore_paged_L1_tester_globalMethods();
