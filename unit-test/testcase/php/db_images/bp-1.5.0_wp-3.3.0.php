...
function bpm_remap_bp15wp33($db_object, $stub, &$error=null){
    
// To create the re-mapping solution:
//
// 1) Create a WP install using the db 'bpm_test' with user = test / pass = test
// 2) Install and activate BuddyPress
// 3) Install BP-Media to a DISTINCT plugin directory like "foo_plugin'
// 4) Activate BP-Media
// 5) Pull a db image
// 6) Delete the entire install and database
// 7) Create a new WP install using the db 'bpm_test' with user = test / pass = test
// 8) Install and activate BuddyPress
// 9) Install BP-Media to a DISTINCT plugin directory like "bar_plugin', different from the first directory
// 10) Activate BP-Media
// 11) Pull a db image
...
//     causes a "Cannot find class BPM_db" error at the start of the unit tests.
	...
	if($stub == "bp-media"){
		...
		if($result){
			...
			// (36, 0, 'active_plugins', 'a:2:{i:0;s:19:"bp-media/loader.php";i:1;s:24:"buddypress/bp-loader.php";}', 'yes'),
			// (112, 0, '_site_transient_update_plugins', 'O:8:"stdClass":3:{s:12:"last_checked";i:1313427422;s:7:"checked";a:4:{s:19:"akismet/akismet.php";s:5:"2.5.3";s:24:"buddypress/bp-loader.php";s:10:"1.5-beta-2";s:19:"bp-media/loader.php";s:5:"0.1.9";s:9:"hello.php";s:3:"1.6";}s:8:"response";a:0:{}}', 'yes'),
			// (154, 0, '_transient_plugin_slugs', 'a:4:{i:0;s:19:"akismet/akismet.php";i:1;s:24:"buddypress/bp-loader.php";i:2;s:19:"bp-media/loader.php";i:3;s:9:"hello.php";}', 'no'),
