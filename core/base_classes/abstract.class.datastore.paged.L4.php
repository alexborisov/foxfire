...
abstract class FOX_dataStore_paged_L4_base extends FOX_db_base {
	...
	public function replaceL2($L4, $L3, $L2, $data, $ctrl=null){
		...
		try {
			$rows_changed = self::replaceL2_multi($replace_data, $replace_ctrl=null);
		}
		catch (FOX_exception $child) {
	...
	public function replaceL3($L4, $L3, $data, $ctrl=null){
		...
		try {
			$rows_changed = self::replaceL3_multi($replace_data, $replace_ctrl=null);
		}
		catch (FOX_exception $child) {
	...
	public function replaceL4($L4, $data, $ctrl=null){
		...
		try {
			$rows_changed = self::replaceL4_multi($replace_data, $replace_ctrl=null);
		}
		catch (FOX_exception $child) {
