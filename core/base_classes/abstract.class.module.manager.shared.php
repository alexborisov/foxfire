...
/**
 * FOXFIRE SHARED MODULE MANAGER BASE CLASS
 * Handles registration and configuration for modules that are shared between multiple plugins
 *
 * @version 1.0
 * @since 1.0
 * @package FoxFire
...
abstract class FOX_moduleManager_shared_base extends FOX_db_base {
