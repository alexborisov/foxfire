...
/**
 * FOXFIRE GEOSPATIAL COLLECTION CLASS
 * 
 * A geometry is a collection if it is made up of other component geometries. Therefore everything but 
 * a Point is a Collection. For example a LineString is a collection of Points. A Polygon is a collection 
 * of LineStrings etc.
 * 
 * @version 1.0
 * @since 1.0
...
abstract class FOX_collection extends FOX_geometry {
	...
	public function __construct($components = array()) {
		...
		if( !is_array($components) ){
			...
			throw new FOX_exception( array(
				'numeric'=>1,
				'text'=>"Component geometries must be passed as an array",
				'data'=>$components,
		...
		foreach( $components as $component ){
			...
			if( $component instanceof FOX_geometry ){
				...
				throw new FOX_exception( array(
					'numeric'=>2,
					'text'=>"Cannot create a collection with non-geometries",
					'data'=>array('components'=>$components, 'faulting_item'=>$component),
					'file'=>__FILE__, 'class'=>__CLASS__, 'function'=>__FUNCTION__, 'line'=>__LINE__,  
					'child'=>null
				));				
			}
