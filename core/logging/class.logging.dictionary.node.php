...
/**
 * RADIENT SYSTEM LOGGING DICTIONARY - NODE
...
class FOX_log_dictionary_node extends FOX_dictionary_base {
	...
	public static $struct = array(
		...
		"table" => "FOX_sys_log_dictionary_node",
		"engine" => "InnoDB", // Required for transactions
		"cache_namespace" => "FOX_log_dictionary_node",
...
function install_FOX_log_dictionary_node(){

	$cls = new FOX_log_dictionary_node();
...
add_action( 'fox_install', 'install_FOX_log_dictionary_node', 2 );
...
function uninstall_FOX_log_dictionary_node(){
...
add_action( 'fox_uninstall', 'uninstall_FOX_log_dictionary_node', 2 );
