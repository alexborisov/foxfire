...
/**
 * FOXFIRE DATA VALIDATION AND SANITIZATION CLASS
...
class FOX_dataIntegrity_validate {

    
	var $last_output;			    // Sanitized value of last call
	var $last_error;			    // Reaon last call failed
	...
	public function __construct($args=null) {
		...
		$this->last_output = FOX_sUtil::keyExists('last_output', $args) ? $args['last_output'] : null;	
		$this->last_error = FOX_sUtil::keyExists('last_error', $args) ? $args['last_error'] : null;
		
	}	
	
	
	/**
	 * Returns the value of the last object processed
         *
         * @version 1.0
         * @since 1.0
	 */
	...
	public function debug($input, $ctrl=null){
