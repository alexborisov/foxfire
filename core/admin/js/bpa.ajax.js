...
nggAjax = {
		settings: {
			url: bpaAjaxSetup.url,
			type: "POST",
			action: bpaAjaxSetup.action,
			operation : bpaAjaxSetup.operation,
			nonce: bpaAjaxSetup.nonce,
			ids: bpaAjaxSetup.ids,
			permission: bpaAjaxSetup.permission,
			error: bpaAjaxSetup.error,
			failure: bpaAjaxSetup.failure,
			timeout: 10000
		},
